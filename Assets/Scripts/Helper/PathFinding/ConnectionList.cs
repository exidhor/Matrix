...
namespace Matrix
{
    public class ConnectionList
    {
        ...
        {
            Coord leftCoord = new Coord(currentNode.Coord.x - 1, currentNode.Coord.y);
        ...
        {
            Coord rightCoord = new Coord(currentNode.Coord.x + 1, currentNode.Coord.y);
        ...
        {
            Coord topCoord = new Coord(currentNode.Coord.x, currentNode.Coord.y + 1);
        ...
        {
            Coord botCoord = new Coord(currentNode.Coord.x, currentNode.Coord.y - 1);
        ...
        public void ComputeTopLeftDiagonalFromSide(Node currentNode, NodeGrid grid)
        {
            ...
            Coord topLeft = new Coord(currentNode.Coord.x - 1, currentNode.Coord.y + 1);
        ...
        {
            Connection newConnection = null;
            Coord topRight = new Coord(currentNode.Coord.x + 1, currentNode.Coord.y + 1);
        ...
        private void EtablishConnection(int index, Connection connection, Coord otherCoord, NodeGrid grid)
        {
        ...
        private Connection CheckSideConnection(Node currentNode, Coord destinationCoord, NodeGrid grid)
        {
